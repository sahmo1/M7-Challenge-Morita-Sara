...
SELECT first_name, last_name, phone FROM customers WHERE phone LIKE '___202%';

/*List the first name, last name, and phone number for all customers from the 202 area code, ordered by last name, first name.*/

SELECT first_name, last_name, phone FROM customers WHERE phone LIKE '___202%' ORDER BY last_name, first_name ASC ;